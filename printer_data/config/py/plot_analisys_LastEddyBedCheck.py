...
FILE = Path("/home/biqu/printer_data/config/py/Analisys/AutoGenerated_EddyBedCheck.json")
LAST_N = 15
...
def main():
    ...
    out_img = FILE.parent / f"AutoGenerated_EddyBedCheck_{ts}.png"
    out_html = FILE.parent / f"AutoGenerated_EddyBedCheck_{ts}.html"
